		...
		<div class="row">
			<div class="col-lg-6 col-md-9 col-sm-12 join-form">
				...
				<form action="<c:url value='/user/userJoin' />" method="post" id = "formObj">
					...
					<div class="form-group">
						<input type="text" class="form-control" id="addrBasic" name ="userAddr1"
							placeholder="기본주소">
					</div>
					<div class="form-group">
						<input type="text" class="form-control" id="addrDetail" name ="userAddr2"
							placeholder="상세주소">
					</div>
